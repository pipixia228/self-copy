...
struct GetParamRequest_
{
  ...
  _name_type name;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _default_type;
...
struct Printer< ::rosapi::GetParamRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosapi::GetParamRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "default: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.default);
  }
};
